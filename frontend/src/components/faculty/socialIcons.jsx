/**
 * Brand-style icons for faculty social/research profile links.
 * Google Scholar, ORCID, ResearchGate paths adapted from Simple Icons (CC0).
 */
export function GoogleScholarIcon({ size = 32, className = "" }) {
  return (
    <svg
      className={className}
      role="img"
...
export function OrcidIcon({ size = 32, className = "" }) {
  return (
    <svg
      className={className}
      role="img"
...
export function ResearchGateIcon({ size = 32, className = "" }) {
  return (
    <svg
      className={className}
      role="img"
